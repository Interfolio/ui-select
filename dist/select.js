 ...
 * Version: 0.21.1 - 2021-02-12T05:12:00.226Z
 * License: MIT
 */
...
uis.directive('uiSelectSingle', ['$timeout','$compile', function($timeout, $compile) {
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      var focusser = angular.element("<input ng-disabled='$select.disabled' class='ui-select-focusser ui-select-offscreen' type='text' id='{{ $select.focusserId }}' aria-label='{{ $select.focusserTitle }}' aria-placeholder='{{ $select.placeholder }}' ng-attr-aria-describedby='{{ $select.describedby }}' aria-required='{{ $select.required }}' aria-haspopup='true' role='combobox' />");
...
$templateCache.put("bootstrap/select-multiple.tpl.html","<div class=\"ui-select-container ui-select-multiple ui-select-bootstrap dropdown form-control\" ng-class=\"{open: $select.open}\"><span ng-if=\"$select.description\" class=\"ui-select-visually-hidden\" id=\"ui-select-description-{{ $select.generatedId }}\">{{ $select.description }}</span><div><div class=\"ui-select-match\"></div><span ng-show=\"$select.open && $select.refreshing && $select.spinnerEnabled\" class=\"ui-select-refreshing {{$select.spinnerClass}}\"></span> <input type=\"search\" autocomplete=\"off\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"false\" class=\"ui-select-search input-xs\" placeholder=\"{{$select.getPlaceholder()}}\" aria-placeholder=\"{{$select.placeholder}}\" ng-attr-aria-describedby=\"{{$select.describedby}}\" ng-disabled=\"$select.disabled\" ng-click=\"$select.activate()\" ng-model=\"$select.search\" role=\"combobox\" aria-expanded=\"{{$select.open}}\" aria-label=\"{{$select.baseTitle}}\" aria-required=\"{{$select.required}}\" ng-class=\"{\'spinner\': $select.refreshing}\" data-disallow-drop=\"data-disallow-drop\"></div><div ng-show=\"$select.open && $select.items.length > 0\" class=\"ui-select-dropdown dropdown-menu\"><div class=\"ui-select-header\"></div><div class=\"ui-select-choices\"></div><div class=\"ui-select-footer\"></div></div><div class=\"ui-select-no-choice\"></div></div>");
$templateCache.put("bootstrap/select.tpl.html","<div class=\"ui-select-container ui-select-bootstrap dropdown\" ng-class=\"{open: $select.open}\"><span ng-if=\"$select.description\" class=\"ui-select-visually-hidden\" id=\"ui-select-description-{{ $select.generatedId }}\">{{ $select.description }}</span><div class=\"ui-select-match\"></div><span ng-show=\"$select.open && $select.refreshing && $select.spinnerEnabled\" class=\"ui-select-refreshing {{$select.spinnerClass}}\"></span><div role=\"combobox\" aria-haspopup=\"listbox\" aria-expanded=\"false\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\"><input type=\"search\" autocomplete=\"off\" tabindex=\"-1\" aria-autocomplete=\"list\" placeholder=\"{{$select.placeholder}}\" aria-required=\"{{ $select.required }}\" class=\"form-control ui-select-search\" aria-label=\"{{ $select.baseTitle }}\" aria-controls=\"ui-select-choices-{{ $select.generatedId }}\" ng-class=\"{ \'ui-select-search-hidden\' : !$select.searchEnabled }\" ng-model=\"$select.search\" ng-show=\"$select.open\"></div><div ng-show=\"$select.open && $select.items.length > 0\" class=\"ui-select-dropdown dropdown-menu\"><div class=\"ui-select-header\"></div><div class=\"ui-select-choices\"></div><div class=\"ui-select-footer\"></div></div><div class=\"ui-select-no-choice\"></div></div>");
